...
const PromoteToModerator = () => {
  ...
  const handlePromoteUser = async () => {
    ...
    const confirmPromote = window.confirm(`Are you sure you want to promote user ID: ${userId} to moderator?`);
  ...
  return (
    <div className="max-w-md mx-auto p-6 mt-10 bg-white rounded shadow">
      <h1 className="text-2xl font-bold mb-4">Promote User to Moderator</h1>
